    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                <a href="/" class="text-xl font-bold text-orange-600">Logo</a>
            </div>
...
<CardGroup cols={2}>
  ...
  <Card title="HTMX" icon="bolt" href="/frontend/htmx">
    Add interactivity
  </Card>
  <Card title="Examples" icon="code" href="/guides/examples">
    Full-stack example
  </Card>
  <Card title="Static Files" icon="folder" href="/core-concepts/static-files">
    Serve assets
  </Card>
</CardGroup>
